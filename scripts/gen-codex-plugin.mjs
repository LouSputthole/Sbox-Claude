...
const codexReleaseDate = `2026-07-16`;
...
**Recommended immutable release tag:** \`${codexTag}\`. The repository's existing \`v${ver}\` tag predates this Codex package and must not be moved.
