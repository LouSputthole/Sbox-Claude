...
- [Razor Panels](#razor-panels)
  - [File Structure](#file-structure)
  - [PanelComponent (Root)](#panelcomponent-root)
  ...
  - [RenderFragment (Reusable Components)](#renderfragment-reusable-components)
  - [RenderFragment\ (Templated Components)](#renderfragment-templated-components)
  - [Generic Panels](#generic-panels)
- [Panel vs PanelComponent Differences](#panel-vs-panelcomponent-differences)
- [Styling](#styling)
  - [SCSS Stylesheets](#scss-stylesheets)
  - [Inline Styles](#inline-styles)
  - [Style Blocks](#style-blocks)
  - [Runtime Style Modification](#runtime-style-modification)
  - [CSS Classes (C# API)](#css-classes-c-api)
- [Layout System](#layout-system)
  - [Key Layout Properties](#key-layout-properties)
  - [Length Units](#length-units)
- [Transitions & Animations](#transitions--animations)
  - [CSS Transitions](#css-transitions)
  - [Intro/Outro (s&box specific)](#introoutro-sbox-specific)
  - [CSS Animations](#css-animations)
  - [Sound on State Change](#sound-on-state-change)
- [Panel API](#panel-api)
  - [Tree / Hierarchy](#tree--hierarchy)
  - [Identity & Classes](#identity--classes)
  - [Visibility & Focus](#visibility--focus)
  - [Scrolling](#scrolling)
  - [Events](#events)
...
- [Event Types](#event-types)
  - [Common Razor Events](#common-razor-events)
- [Localization](#localization)
- [Common Style Properties (Quick Reference)](#common-style-properties-quick-reference)
  - [Differences from Web CSS](#differences-from-web-css)
