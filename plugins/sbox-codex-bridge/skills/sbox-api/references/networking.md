...
- [Ownership](#ownership)
  ...
  - [The IsProxy Pattern](#the-isproxy-pattern)
  - [Ownership Transfer](#ownership-transfer)
  - [OwnerTransfer Mode](#ownertransfer-mode)
  - [Orphaned Mode (Disconnect Handling)](#orphaned-mode-disconnect-handling)
  - [Network Accessor (go.Network)](#network-accessor-gonetwork)
  - [NetworkFlags](#networkflags)
- [Transform Interpolation](#transform-interpolation)
- [Network Events](#network-events)
  - [INetworkListener (Host Only)](#inetworklistener-host-only)
  - [INetworkSpawn](#inetworkspawn)
  - [IGameObjectNetworkEvents](#igameobjectnetworkevents)
  - [INetworkSnapshot (Custom Snapshot Data)](#inetworksnapshot-custom-snapshot-data)
- [Network Visibility](#network-visibility)
- [NetworkHelper Component](#networkhelper-component)
- [Scene Startup (ISceneStartup)](#scene-startup-iscenestartup)
- [Dedicated Servers](#dedicated-servers)
  - [Server-Side Code](#server-side-code)
  - [User Permissions](#user-permissions)
- [Common Patterns](#common-patterns)
  - [Player Controller with Networking](#player-controller-with-networking)
