...
- [GameObjects](#gameobjects)
  ...
  - [Transform](#transform)
  - [Tags](#tags)
  - [Children & Hierarchy](#children--hierarchy)
  - [Key Properties](#key-properties)
- [Components](#components)
  - [Writing a Custom Component](#writing-a-custom-component)
  - [Adding & Querying Components](#adding--querying-components)
  - [Removing / Destroying](#removing--destroying)
  - [Component References in Inspector](#component-references-in-inspector)
- [Lifecycle Methods](#lifecycle-methods)
  - [Execution Order](#execution-order)
  - [Method Details](#method-details)
  - [Additional Virtual Methods](#additional-virtual-methods)
  - [Execution Order Warning](#execution-order-warning)
- [Component Interfaces](#component-interfaces)
  - [ExecuteInEditor](#executeineditor)
  - [ICollisionListener](#icollisionlistener)
  - [ITriggerListener](#itriggerlistener)
  - [IDamageable](#idamageable)
- [Properties (Editor Attributes)](#properties-editor-attributes)
  - [Common Attributes](#common-attributes)
  - [String-Specific](#string-specific)
  - [Validation](#validation)
- [Prefabs](#prefabs)
  - [Spawning in Code](#spawning-in-code)
  - [Instance Overrides](#instance-overrides)
  - [Static Prefab Loading](#static-prefab-loading)
...
- [Async in Components](#async-in-components)
- [Unity Anti-Pattern Table](#unity-anti-pattern-table)
- [.NET Restrictions](#net-restrictions)
<!-- reference-toc:end -->
