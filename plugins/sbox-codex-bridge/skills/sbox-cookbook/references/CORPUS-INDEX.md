# Corpus Index — Cross-Reference of 51 Public-Source s&box Games
...
- [SYSTEMS](#systems)
  - [inventory](#inventory)
  - [economy-currency](#economy-currency)
  - [shop-vendor](#shop-vendor)
  - [save-persistence](#save-persistence)
  - [progression-upgrades](#progression-upgrades)
  - [gacha-loot](#gacha-loot)
  - [genetics-breeding](#genetics-breeding)
  - [leaderboards-services](#leaderboards-services)
  - [idle-offline](#idle-offline)
  - [building-placement](#building-placement)
  - [crafting](#crafting)
  - [dialogue](#dialogue)
  - [round-match](#round-match)
  - [spawning-waves](#spawning-waves)
  - [anti-cheat](#anti-cheat)
  - [level-design](#level-design)
  - [ai-director](#ai-director)
  - [services-backend](#services-backend)
- [GENRES](#genres)
  - [tycoon-idle](#tycoon-idle)
  - [shopkeeper](#shopkeeper)
  - [document-sim](#document-sim)
  - [roleplay](#roleplay)
  - [sandbox-voxel](#sandbox-voxel)
  - [social-hub](#social-hub)
  - [platformer-obstacle](#platformer-obstacle)
  - [deathmatch-arena](#deathmatch-arena)
  - [card-battler](#card-battler)
  - [survival-horror](#survival-horror)
  - [gacha-crawler](#gacha-crawler)
  - [puzzle](#puzzle)
  - [vehicles](#vehicles)
  - [party-microgame](#party-microgame)
  - [social-deduction](#social-deduction)
  - [survivor-roguelite](#survivor-roguelite)
  - [coop-kitchen](#coop-kitchen)
  - [board-game](#board-game)
  - [casino-gambling](#casino-gambling)
  - [physics-sports](#physics-sports)
<!-- reference-toc:end -->

Cross-reference of which corpus games implement each system or genre. Use it
to find reference implementations to compose, and see
[Source Provenance](SOURCE-PROVENANCE.md) for the exact package identifiers,
live source links, and upstream-license caveat. Cited file paths are relative
to the named upstream packages; upstream source is not bundled here.
