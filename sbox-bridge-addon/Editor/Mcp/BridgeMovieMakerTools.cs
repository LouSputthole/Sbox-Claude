...
public static class BridgeMovieMakerTools
{
	...
	/// Maker dock: Window → Movie Maker). Returns each movie's asset-relative path, whether it
	/// currently loads via ResourceLibrary, and whether it has a compiled clip. Start here before
	/// add_movie_player / play_movie — and if the list is empty, the movie has to be authored in the
	/// dock first (the bridge plays movies; it doesn't author keyframes).
	/// </summary>
